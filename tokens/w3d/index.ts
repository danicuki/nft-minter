...
const TOKEN_NAME = "WEB3DEV"
const TOKEN_SYMBOL = "W3D"
const TOKEN_DESCRIPTION = "A token for WEB3DEVERS"
const TOKEN_IMAGE_NAME = "w3d.png" // Replace unicorn.png with your image name
const TOKEN_IMAGE_PATH = `tokens/w3d/assets/${TOKEN_IMAGE_NAME}`
